...
function promedioResultadosTest(resultadosTest) {
  ...
  var suma = 0;
    ...
    for(i = 0; i < resultadosTest.length; i++){
      ...
      divide = suma / resultadosTest.length
    }
...
function breakStatement(numero) {
  ...
  for (var i = 0; i < 10; i++){
    ...
    if (suma === i){
      ...
      numerosAumentados.push(suma);
    }
  }

  if (numerosAumentados.length < 10){
...
function continueStatement(numero) {
  ...
  for (var i = 0; i < 10; i++){
    if (i === 5){
      ...
      suma += 2;
      elNumeroDeDos.push(suma)
    }
  }

  return elNumeroDeDos;
}
